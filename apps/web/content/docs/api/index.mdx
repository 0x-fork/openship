---
title: API overview
description: Control Openship through HTTP or the Node.js SDK. Authentication, permissions, API modules, and integration guides.
---

Use the Openship API to create projects, trigger deployments, attach domains, read analytics, and manage
backups from a script, CI job, or AI agent. The dashboard and remote [`openship`](/docs/cli) CLI use the JSON
HTTP API. The [Node.js SDK](/docs/api/sdk) provides a typed HTTP client and a native interface that runs the
shared platform services inside your Node application.

Start with the [SDK guide](/docs/api/sdk) for imports, release availability, native identity scopes, and the
current method reference. The module pages below describe the HTTP endpoints and their payloads.
...
<Cards>
  <Card title="Node.js SDK" href="/docs/api/sdk" description="Native and remote clients, deployment workflows, tenant scopes, and the public method reference." />
  ...
  <Card title="Apps" href="/docs/api/apps" description="Browse the one-click app catalog, install apps, and manage custom apps." />
