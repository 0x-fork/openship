/**
 * Deployment validation schemas - Shared TypeBox operation contracts.
 */
...
export const TriggerDeployBody = CreateDeploymentSchema;
 ...
 */
export const BuildServiceInput = Type.Object({
  name: Type.String(),
