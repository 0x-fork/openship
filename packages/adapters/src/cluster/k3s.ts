...
export function k3sFirewallScript(ctx: K3sHostContext): string {
  ...
  if (!ctx.plan.podCidr)
    throw failure("Allocate the pod network before configuring the cluster firewall.");
